      ...
      <header className="relative z-10 w-full max-w-screen-2xl flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5 md:gap-2">
          ...
          <a
              ...
              className="hidden md:inline-flex px-3 py-0.5 border border-sky-300 bg-[#dbeeff] hover:bg-sky-50 rounded text-sm font-medium text-sky-700"
            >
              Feedback
            </a>
          <span className="hof-rainbow">
            <button
              ...
              className="px-2 py-0.5 md:px-3 md:py-0.5 bg-[#fef7d9] hover:bg-amber-50 text-[11px] md:text-sm font-medium text-amber-700"
            >
              Hall of Fame
            </button>
          </span>
          <button
            ...
            className="px-2 py-0.5 md:px-3 md:py-0.5 border border-emerald-300 bg-[#d8f5e3] hover:bg-emerald-50 rounded text-[11px] md:text-sm font-medium text-emerald-700"
          >
            Join
          </button>
        </div>
